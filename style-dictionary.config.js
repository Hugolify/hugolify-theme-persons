...
// -------------------------------------------------------
// Barrel — assets/css/tokens/persons.css imports every generated component
// token file. Token files are discovered from disk, so modules/persons.css
// imports this barrel once and adding a token JSON needs no manual edit. Each
// file declares its own @layer tokens, so a plain @import is enough.
// -------------------------------------------------------

fs.writeFileSync(
  './assets/css/tokens/persons.css',
